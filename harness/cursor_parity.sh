...
if ran_r == 0 or ran_p == 0:
    ...
    sys.exit(1)
# Ratcheted, not zero. 61 tests differ today and closing them is a programme
# of work, not a run of this script; what must not happen quietly is the
# number GROWING. Exact match, as the repo's other ratchets are, so fixing
