...
class _RustPool:
    ...
    def __init__(self, conninfo="", *, kwargs=None, min_size=0, max_size=None,
                 max_idle=None, configure=None, reset=None, check=None,
                 open=True, **_unused):
    ...
    def putconn(self, conn):
        ...
        with self._cond:
            ...
            if keep and room and not self._closed and not conn.closed:
